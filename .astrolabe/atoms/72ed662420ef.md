...
content: "∀ {E : Type u_1} [inst : NormedAddCommGroup E] [inst_1 : NormedSpace ℝ E]\
  ...
  \ {x : M},\n  x ∈ (trivializationAt E (TangentSpace I) α).baseSet → (Riemannian.Tensor.chartGramMatrix\
  \ g α x).PosDef"
file: Riemannian/TensorBundle/MusicalIso.lean
line: 141
name: Riemannian.Tensor.chartGramMatrix_posDef
