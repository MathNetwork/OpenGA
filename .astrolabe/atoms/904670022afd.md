...
content: "∀ {E : Type u_1} [inst : NormedAddCommGroup E] [inst_1 : NormedSpace ℝ E]\
  ...
  \ : Fin (Module.finrank ℝ E)),\n      ((g.inner b) (Riemannian.Tensor.chartFrameNormFiber\
  \ g α b i)) (Riemannian.Tensor.chartFrameNormFiber g α b j) =\n        if i = j\
  \ then 1 else 0"
file: Riemannian/TensorBundle/SmoothOrthoFrame/Orthonormality.lean
line: 400
name: Riemannian.Tensor.chartFrameNormFiber_orthonormal
...
source: lean
state: proven
title: chartFrameNormFiber_orthonormal
---
