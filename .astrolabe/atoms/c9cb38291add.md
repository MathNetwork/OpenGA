...
content: "∀ {E : Type u_1} [inst : NormedAddCommGroup E] [inst_1 : NormedSpace ℝ E]\
  ...
  \  ContMDiffOn I (modelWithCornersSelf ℝ ℝ) (↑⊤) (fun x => (Riemannian.Tensor.chartGramMatrix\
  \ g α x).det)\n    (trivializationAt E (TangentSpace I) α).baseSet"
file: Riemannian/TensorBundle/MusicalIso.lean
line: 203
name: Riemannian.Tensor.chartGramMatrix_det_contMDiffOn
...
source: lean
state: proven
title: chartGramMatrix_det_contMDiffOn
---
