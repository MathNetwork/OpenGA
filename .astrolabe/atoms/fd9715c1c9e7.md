...
content: "∀ {E : Type u_1} [inst : NormedAddCommGroup E] [inst_1 : NormedSpace ℝ E]\
  ...
  \ {x : M},\n  x ∈ (trivializationAt E (TangentSpace I) α).baseSet →\n    Riemannian.Tensor.chartGramMatrix\
  \ g α x * Riemannian.Tensor.chartInvGramMatrix g α x = 1"
file: Riemannian/TensorBundle/MusicalIso.lean
line: 300
name: Riemannian.Tensor.chartGramMatrix_mul_chartInvGramMatrix
...
source: lean
state: proven
title: chartGramMatrix_mul_chartInvGramMatrix
---
