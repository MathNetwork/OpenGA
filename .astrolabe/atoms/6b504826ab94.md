...
content: "∀ {E : Type u_1} [inst : NormedAddCommGroup E] [inst_1 : NormedSpace ℝ E]\
  ...
  \ (↑⊤) (fun x => (Riemannian.Tensor.chartGramMatrix g α x).adjugate i j)\n    (trivializationAt\
  \ E (TangentSpace I) α).baseSet"
file: Riemannian/TensorBundle/MusicalIso.lean
line: 230
name: Riemannian.Tensor.chartGramMatrix_adjugate_entry_contMDiffOn
...
source: lean
state: proven
title: chartGramMatrix_adjugate_entry_contMDiffOn
---
