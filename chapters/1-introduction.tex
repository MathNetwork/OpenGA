...
Liokumovich--Marques--Neves \cite{LMN} proved Gromov's conjecture for hypersurfaces,
...
Having discussed existence and multiplicity, we now turn to the \emph{regularity question}: Are minimal hypersurfaces
...
\begin{theorem}[Main Theorem: Free Boundary in Complete Manifolds]\label{thm:main}
    ...
    $\Sigma$ with boundary $\partial\Sigma \subset \partial M$ such that
    \begin{enumerate}
