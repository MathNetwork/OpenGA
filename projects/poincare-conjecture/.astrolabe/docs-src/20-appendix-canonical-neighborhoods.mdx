...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.1" label="curveshort" -->
**Lemma.** The following holds for all $\epsilon>0$ sufficiently small. Suppose
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.2" label="neckcurv" -->
**Lemma.** For any $0<\alpha<1/8$ there is $\epsilon_1=\epsilon_1(\alpha)>0$ such that
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="19.3" label="s2isotopic" -->
**Corollary.** The following holds for any $\epsilon>0$ sufficiently small. Suppose
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.4" label="directions" -->
**Lemma.** For any $\alpha>0$ there is $\epsilon_2=\epsilon_2(\alpha)>0$
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="19.5" label="neckgeo" -->
**Corollary.** For any $\alpha>0$ there is $\epsilon_3=\epsilon_3(\alpha)>0$ such
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="19.6" label="compint" -->
**Corollary.** The following holds for all $\epsilon>0$ sufficiently small. Let $N$
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.7" label="genint" -->
**Lemma.** The following holds for every $\epsilon>0$ sufficiently small.
...
in the neck structure on $N$ at most once; see Fig. 19.1.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="19.8" label="coreint" -->
**Corollary.** The following holds for all $\epsilon>0$ sufficiently small and any
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.9" label="neckdistcomp" -->
**Lemma.** Given $0<\alpha<1$ there is $\epsilon_4=\epsilon_4(\alpha)>0$ such
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.10" label="topiso" -->
**Lemma.** Given any $\alpha>0$ there is $\epsilon(\alpha)>0$ such that the
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="19.11" label="S2intersection" -->
**Proposition.** Given $0<\alpha\le 10^{-2}$, there is
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="19.12" -->
**Definition.** Let $(X,g)$ be a Riemannian manifold. By a *finite chain* of
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.13" label="S2timesI" -->
**Lemma.** The union $U$ of the $N_i$ in a finite or infinite chain of
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="19.14" label="chainfrontier" -->
**Corollary.** Let $\{N_a,\ldots,N_b\}$ be a chain of $\epsilon$-necks. If a
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.15" label="inffrontier" -->
**Lemma.** Suppose that $\{N_0,\cdots\}$ is an infinite chain of
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.16" -->
**Lemma.** There is $\epsilon_0>0$ such that the following holds for all
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.17" label="firstchain" -->
**Lemma.** There exists $\epsilon_0>0$ such that for all $0<\epsilon\le
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.18" label="addaneck" -->
**Lemma.** There exists $\epsilon_0>0$ such that for all $0<\epsilon\le
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="19.19" label="epschains" -->
**Proposition.** There exists $\epsilon_0>0$ such that for all $0<\epsilon\le
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="19.20" label="S2times01" -->
**Lemma.** The following holds for every $\epsilon>0$ sufficiently small. Let
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="19.21" label="Xcontainedin" -->
**Proposition.** For any $C<\infty$ the following holds. Suppose that $X$ is a
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="19.22" -->
**Claim.** It is not possible to have an infinite chain of $(C,\epsilon)$-caps
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="19.23" label="cccomponent" -->
**Claim.** If $C'$ is a $(C,\epsilon)$-cap whose core contains a point of the
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="19.24" label="sinside" -->
**Claim.** Suppose that there is a two-sphere $\Sigma\subset N'$ contained in
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="19.25" label="epstopology" -->
**Proposition.** For all $\epsilon>0$ sufficiently small the following holds. Suppose
