...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.2" label="defnRicci" -->
**Definition.** We introduce some notation that will be used throughout. Given a
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="3.3" -->
**Example.** The standard metric on each of $S^{n}, \Ar^{n},$ and ${\mathbb
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="3.4" -->
**Example.** $\mathbb{C}P^{n}$ equipped with the Fubini-Study metric, which is induced
from the standard metric of $S^{2n+1}$ under the Hopf fibration with the fibers
of great circles, is Einstein.
<!-- astrolabe:end -->

<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="3.5" -->
**Example.** Let $h_0$ be the round metric on $S^2$ with constant Gausssian
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.6" label="strongepsneck" -->
**Definition.** Let $(M,g(t))$ be a Ricci flow. An *evolving $\epsilon$-neck
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="3.7" label="solitonclaim" -->
**Claim.** The flow
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.8" -->
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="3.9" label="GSSgeneration" -->
**Proposition.** Suppose we have a complete Riemannian manifold $(M,g(0))$, a
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.10" -->
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="3.11" label="compuniq" -->
**Theorem.** **(Hamilton, cf.
[Hamilton3MPRC].)** Let $(M,g_0)$ be a compact
Riemannian manifold of dimension $n$.

1. There is a $T>0$ depending on $(M,g_0)$ and a Ricci flow
$(M,g(t)),\  0\le t<T$, with $g(0)=g_0$.
1. Suppose that we have Ricci flows with initial conditions $(M,g_0)$ at time
$0$ defined respectively on time intervals $I$ and $I'$. Then these
flows agree on $I\cap I'$.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="3.12" label="patch" -->
**Proposition.** Suppose that $(U,g(t)),\ a\le t<b$, is a Ricci flow and suppose that
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="3.13" label="thmRmevol" -->
**Theorem.** The curvature tensor $R_{ijkl}$, the Ricci curvature $\mathit{Ric}_{ij}$, the scalar
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="3.14" label="posdistdec" -->
**Lemma.** Suppose that $(M,g(t)),\ a<t<b$ is a Ricci flow of non-negative Ricci curvature
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="3.15" -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="3.16" label="ortho" -->
**Claim.** Suppose that ${\mathcal F}(0)=\{F_a\}_a$ is a local $g(0)$-orthonormal frame,
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="3.17" -->
**Corollary.**
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="3.18" label="M" -->
**Lemma.** Suppose that the orthonormal frame ${\mathcal F}(t)$ evolves by
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="3.19" label="Mevol" -->
**Proposition.** The evolution of the curvature operator ${\mathcal
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="3.20" -->
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="3.21" label="I.8.3" -->
**Proposition.** Let $t_0\in \Ar$ and let $(M,g(t))$ be a Ricci flow defined for $t$ in an interval containing $t_0$
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="3.22" -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="3.23" label="geosuff" -->
**Claim.** Suppose that for every minimal $g(t_0)$-geodesic $\gamma$ from $x_0$
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="3.24" label="3.23" -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="3.25" label="2ndI.8.3" -->
**Corollary.** Let $t_0\in \Ar$ and let $(M,g(t))$ be a Ricci flow defined for $t$ in an
interval
containing $t_0$ and with $(M,g(t))$ complete for every $t$ in this
interval. Fix a constant $K<\infty$. Suppose that $\mathit{Ric}(x,t_0)\le (n-1)K$
for all $x\in M$.
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="3.26" label="corI.8.3" -->
**Corollary.** Let $(M,g(t)),\ a\le t\le b$, be a Ricci flow with $(M,g(t))$ complete for every $t
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="3.27" label="firstshi" -->
**Theorem.** There is a constant $C=C(n)$, depending only on the dimension $n$,
...
Ricci flow with $|\mathit{Rm}(x,t)|\le K$ for all $x\in U$ and $t\in [0,T]$.
Suppose that $p\in U$ has the property that $B(p,0,r)$ has compact
closure in $U$. Then

$$
|\nabla \mathit{Rm}(p,t)|\le
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="3.28" label="shi" -->
...
$$
|\mathit{Rm}(x,t)|\le K\ \ \text{for all }\ (x,t)\in P(x,0,r,T),
$$

then

$$
|\nabla^k(\mathit{Rm}(y,t))|\le \frac{C_k}{t^{k/2}}
$$
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="3.29" label="shiw/deriv" -->
**Theorem.** Fix the dimension $n$ of the Ricci flows under consideration. Let
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="3.30" -->
**Remark.** Clearly, the case $l=0$ of \entryref{e0b6a1f646a7} is Shi's theorem
(\entryref{dbe4fabd0076}).
<!-- astrolabe:end -->

\entryref{e0b6a1f646a7} leads immediately to the following:

<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="3.31" label="Cinftybd" -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="3.32" label="Fm" -->
**Claim.** With $F_m$ as defined above and with $C\ge \max(4A^2_m,1)$,
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="3.33" label="etaprop" -->
**Proposition.** Fix constants $0<\alpha$ and the dimension $n$. Then there is a constant
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.34" -->
...
function $\mathbf{t}\colon {\mathcal M}\to \Ar$, called *time* and
a smooth vector field $\chi$ subject to the following axioms:

1. The image of $\mathbf{t}$ is an interval $I$ (possibly infinite) and
the boundary of ${\mathcal M}$ is the preimage under $\mathbf{t}$ of
$\partial I$.
1. For each $x\in {\mathcal M}$ there is an open neighborhood $U\subset
{\mathcal M}$ of $x$ and a diffeomorphism $f\colon  V\times J\to U$,
where $V$ is an open subset in $\Ar ^n$ and $J$ is an interval with
the property that (i) $\mathbf{t}$ is the composition of $f^{-1}$
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.35" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.36" -->
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="3.37" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.38" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.39" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.40" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="3.41" -->
