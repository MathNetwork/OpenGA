...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.1" label="deltareg" -->
**Definition.** Let $(U,g)$ be a Riemannian manifold. Let $\delta>0$ be given. We
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.2" -->
**Lemma.** $\mathit{Reg}_\delta(U,g)$ is a closed subset of $U$.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.3" label="smoothconv" -->
**Definition.** For each $k$
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="5.4" -->
**Remark.** Conditions (1) and (2a) in the definition above also appear in the definition
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.5" -->
**Lemma.** The geometric limit of a sequence $(U_k,g_k,x_k)$ is unique up to
based isometry.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.6" label="basicconv" -->
**Theorem.** Suppose that $\{(U_k,g_k,x_k)\}_{k=1}^\infty$ is a sequence of
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.7" -->
**Lemma.** Suppose that we have a sequence of $n$-dimensional balls $(B_k,h_k)$
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.8" -->
**Lemma.** Suppose that $(U_k,g_k,x_k)$ is a sequence of based Riemannian
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.9" label="mfdconv" -->
**Theorem.** Let $\{(M_k,g_k,x_k)\}_{k=1}^\infty$ be a sequence of connected,
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="5.10" label="2ndmfdconv" -->
**Corollary.** Suppose that $\{(M_k,g_k,x_k)\}_{k=1}^\infty$ is a sequence of based, connected
Riemannian manifolds. Suppose that the first two conditions in
\entryref{c81f82f6f8a1} hold and suppose also that there are constants $\kappa>0$
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.11" label="sliceconv" -->
**Theorem.** Suppose that $({\mathcal M}_k,G_k,x_k)$ is a sequence of based
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.12" -->
**Definition.** Let $\{({\mathcal M}_k,G_k,x_k)\}_{k=1}^\infty$ be a sequence of based
...
M_\infty$ satisfying (1) of \entryref{467f4b920031} with $M_\infty$ in
place of $U_\infty$,
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.13" -->
**Definition.** For $0<T\le \infty$, if $(M_\infty,g_\infty(t),x_\infty),\ -T<t\le 0$, is a
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="5.14" label="partialflowlimit" -->
**Proposition.** Fix constants $-\infty\le T'\le 0\le T\le \infty$ and suppose that $T'<T$. Let
...
$\varphi_k\colon V_k\to M_k$ as in \entryref{467f4b920031}. Suppose that
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.15" label="flowlimit" -->
**Theorem.** Fix $-\infty\le T'\le 0\le T\le \infty$ with $T'<T$. Let $\{({\mathcal
M}_k,G_k,x_k)\}_{k=1}^\infty$ be a sequence of based generalized Ricci flows.
Suppose that $\mathbf{t}(x_k)=0$ for all $k$, and denote by $(M_k,g_k)$ the $0$
...
- **(1)** the ball
$B_{g_k}(x_k,0,A)$ has compact closure in $M_k$,
- **(2)** there is an
embedding $B_{g_k}(x_k,0,A)\times I\to {\mathcal M}_k$ compatible with time and
with the vector field,
- **(3)** the norms of the Riemann curvature of $G_k$ on the image of the embedding in the
previous item are bounded by $C(A,I)$, and
- **(4)** there is $r_0>0$ and $\kappa>0$ with $\mathit{Vol} B(x_k,0,r_0)\ge \kappa r_0^n$
for all $k$ sufficiently large.
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="5.16" -->
**Corollary.** Suppose that $(U,g(t)),\ 0\le t<T<\infty$, is a Ricci flow. Suppose
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.17" label="epsnet" -->
**Definition.** A $\delta$-net in $(X,x)$ is a subset $L$ of $X$ containing $x$
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.18" -->
**Lemma.** The Gromov-Hausdorff distance satisfies the triangle inequality.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.19" label="GHconverge" -->
**Definition.** We say that a sequence of based metric spaces $(X_k,x_k)$ of
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="5.20" -->
**Example.** A sequence of compact $n$-manifolds of diameter tending to zero has
a point as Gromov-Hausdorff limit.
<!-- astrolabe:end -->

<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.21" label="seqconv" -->
**Definition.** Suppose that $\{(X_k,x_k)\}_k$ converges in the Gromov-Hausdorff sense to
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.22" -->
**Lemma.** Let $(X_k,x_k)$ be a sequence of metric spaces whose diameters are uniformly
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.23" -->
**Lemma.** Let $(X_k,x_k)$ be a sequence of based metric spaces whose diameters are
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.24" -->
**Definition.** For based metric spaces $(X_k,x_k)$ (not necessarily of finite
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="5.25" -->
**Lemma.** Let $(X_k,x_k)$ be a sequence of locally compact metric spaces. Suppose that
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="5.26" -->
**Example.** Let $(M_n,g_n,x_n)$ be a sequence of based Riemannian manifolds
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.27" -->
**Definition.** A *length space* is a connected metric space
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.28" label="GHcompact" -->
**Theorem.** Suppose that $(X_k,x_k)$ is a sequence of based length spaces. Then
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.29" -->
**Definition.** Now we define a metric space whose underlying space is the quotient
...
$\theta_\infty$ descends to a metric on this space. This space is a
 length space [BGP]. Notice that the distance between
any two points in this metric space is at most $\pi$. We denote this
space by $S_\infty(M,p)$.
<!-- astrolabe:end -->

<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="5.30" -->
**Claim.** $S_\infty(M,p)$ is a compact space.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="5.31" label="conelimit" -->
**Proposition.** Let $(M,g)$ be a non-negatively curved, complete, non-compact
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="5.32" -->
**Definition.** Let $({\mathcal M}_k,G_k,x_k)$ be a sequence of based
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.33" label="blowupposcurv" -->
**Theorem.** Let $({\mathcal M}_k,G_k,x_k)$ be a sequence of generalized $3$-dimensional
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="5.34" -->
**Corollary.** Suppose that $(M_k,g_k(t))$ is a sequence of Ricci flows each of which has time
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="5.35" label="topsplit" -->
**Theorem.** Let $(M,g)$ be a complete, connected manifold of non-negative
