...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.1" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.2" label="spacetime" -->
**Definition.** A *surgery space-time* is a
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.3" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.4" -->
...
in $I$ of $t$, and a diffeomorphism $M_{t}\times J\to \mathbf{t}^{-1}(J)\subset{\mathcal M}$ compatible with time and the vector
...
with $\mathbf{t}$ and $\chi$ coming from the second factor.
<!-- astrolabe:end -->

<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="14.5" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.6" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.7" -->
**Definition.** By a *horizontal metric $G$ on a surgery space-time ${\mathcal
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.8" -->
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="14.9" -->
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="14.10" -->
**Example.** One example of a Ricci flow with surgery is ${\mathcal M}=M_0\times
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="14.11" label="gluingsoln" -->
**Lemma.** Suppose that we have manifolds $M_1\times (a,b]$ and $M_2\times
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="14.12" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.13" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.14" -->
**Definition.** Let $({\mathcal M},G)$ be a Ricci flow with surgery, and let $x$ be
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.15" label="defnkappa" -->
**Definition.** Fix $\kappa>0$ and $r_0>0$. We say that a Ricci flow with surgery
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="14.16" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.17" -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="14.18" -->
