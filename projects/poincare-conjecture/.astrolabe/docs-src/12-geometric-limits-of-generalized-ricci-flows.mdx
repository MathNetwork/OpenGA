...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="11.1" label="smlmtflow" -->
**Theorem.** Fix canonical neighborhood constants $(C,\epsilon)$, and
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.2" label="controlnbhd" -->
**Lemma.** Let $({\mathcal M},G)$ be a generalized $3$-dimensional Ricci flow.
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="11.3" label="cnnbhd2" -->
**Corollary.** For each $A<\infty$, let $Q(A)$ be a bound on the scalar curvature
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="11.4" -->
**Corollary.** For each $A<\infty$ and for each integer $\ell\ge 0$, there is a
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.5" -->
**Claim.** There is $\eta>0$ such that for all $n$ sufficiently large
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.6" -->
**Claim.** Any point in $(M_\infty,g_\infty)$ of curvature greater than $4$ has
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.7" -->
**Claim.** The limit Riemannian manifold $(M_\infty,g_\infty)$ has bounded
curvature.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="11.8" label="kaplimit" -->
**Theorem.** Suppose that $\{({\mathcal M}_n,G_n,x_n)\}_{n=1}^\infty$ is a
sequence of generalized $3$-dimensional Ricci flows satisfying all
the hypothesis of \entryref{d51aab8a8065}. Suppose in addition that
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="11.9" -->
**Remark.** Let us point out the differences between this result and
\entryref{d51aab8a8065}. The hypotheses of this theorem include all
the hypotheses of \entryref{d51aab8a8065}. The main difference
between the conclusions is that in \entryref{d51aab8a8065} the
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="11.10" label="maxT" -->
**Proposition.** With the notation of, and under the hypotheses of
\entryref{a9e023d082dc}, suppose that there is a geometric limit flow
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.11" label="compactbd" -->
**Lemma.** Suppose that there is a geometric limit flow defined on $(-T,0]$ for
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.12" label="distch" -->
**Claim.** Let $Q$ be an upper bound on $R(x,0)$ for all $x\in
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.13" -->
**Lemma.** Let $(M,g)$ be a complete, connected, non-compact manifold of
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.14" label="outerbd" -->
**Claim.** Fix $D<\infty$ greater than or equal to the constant given in the
previous lemma
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.15" -->
**Claim.** $y$ cannot lie in the core of a $(2C,2\epsilon)$-cap in
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="11.16" label="ancientlimit" -->
**Corollary.** Suppose that there is a geometric limit flow
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.17" -->
**Claim.** For each $A<\infty$ and for all $n$ sufficiently large, there are
...
<!-- astrolabe:begin kind="assumption" src="morgan-tian" mtref="11.18" label="assumptions" -->
**Assumption.** - **(a)** The singular times form a discrete subset of $\Ar$, and
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="11.19" label="omega" -->
**Theorem.** Suppose that $({\mathcal M},G)$ is a generalized Ricci flow defined
for $0\le t<T<\infty$ satisfying the three assumptions given
in \entryref{3009be0a37fc}. Let $T^-<T$ be such that there is a
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="11.20" -->
**Remark.** Recall that by definition a function $f$ is proper if the pre-image
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.21" label="Rproper" -->
**Lemma.** Suppose that $({\mathcal M},G)$ is a generalized Ricci flow defined
for $0\le t<T<\infty$ satisfying the three assumptions given
in \entryref{3009be0a37fc}. Let $T'<T$ be as in the previous theorem, set
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="11.22" label="hatM" -->
**Definition.** Let
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.23" label="omegacanon" -->
**Lemma.** For any $x\in \Omega\times\{T\}$ with $R(x,T)>r_0^{-2}$ one of the
following holds:
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.24" label="epslimit" -->
**Claim.** Fix a point $x\in\Omega$. Suppose that there is a sequence
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="11.25" -->
**Definition.** A *strong $2\epsilon$-horn* in $(\Omega,g(T))$ is a submanifold of $\Omega$ diffeomorphic
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="11.26" -->
**Definition.** A *strong double $2\epsilon$-horn* in
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="11.27" -->
**Definition.** Fix any $\rho,\ 0<\rho<r_0$. We define $\Omega_\rho\subset \Omega$
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.28" -->
**Lemma.** Suppose that $0<\rho<r_0$ and that $\Omega^0$ is a component of
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="11.29" -->
**Remark.** We do not claim that there are only finitely many such components;
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="11.30" label="2epshorns" -->
**Lemma.** Let $({\mathcal M},G)$ be a generalized $3$-dimensional Ricci flow
defined for $0\le t<T<\infty$ satisfying
Assumptions \entryref{3009be0a37fc}. Fix $0<\rho<r_0$. Let
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="11.31" label="hexist" -->
**Theorem.** Fix $\rho>0$. Then for any $\delta>0$ there is an
...
$0\le t<T<\infty$ satisfying Assumptions \entryref{3009be0a37fc} and for
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.32" label="hyp" -->
**Claim.** The sequence $(\widehat{\mathcal M}_n,\widehat G_n,x_n)$ satisfies
the five hypothesis of \entryref{d51aab8a8065}.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.33" -->
**Claim.** For any $A<\infty$ for all $n$ sufficiently large,
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.34" -->
**Claim.** $(M_\infty,g_\infty(0))$ is isometric to the product $(S^2,h)\times
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="11.35" -->
**Claim.** For any $z\in M_\infty$ for all $n$ sufficiently large, $z\in V_n$,
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="11.36" label="hmonotone" -->
**Corollary.** We can take the function $h(\rho,\delta)$ in the last lemma to be
