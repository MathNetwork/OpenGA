...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.1" label="kappadefn" -->
**Definition.** Fix $\kappa>0$. Let $(M,g(t)),\ a<t\le b$, be a Ricci flow of
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.2" -->
**Definition.** An *ancient solution* is a Ricci flow
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="9.3" -->
**Example.** Let $(S^{2},g_{0})$ be the standard round $2$-sphere of scalar
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.4" -->
**Theorem.** Every orientable, $2$-dimensional $\kappa$-solution is a rescaling
of the previous example, i.e., is a family of shrinking round
$2$-spheres.
<!-- astrolabe:end -->

<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="9.5" -->
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="9.6" -->
**Example.** Consider the product $S^{2}\times \mathbb{R} $, with the metric $
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="9.7" -->
**Example.** The quotient $S^{2}\times \mathbb{R}/\langle\iota\rangle$, where the
...
<!-- astrolabe:begin kind="example" src="morgan-tian" mtref="9.8" -->
**Example.** Consider the metric product $(S^{2},g_0) \times (S^{1}_{R},ds^2)$
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.9" label="uniformlip" -->
**Proposition.** Let $(M,g(t)),\ -\tau_0\le t\le 0$, be an $n$-dimensional Ricci flow
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.10" label="unianc" -->
**Corollary.** Let $(M,g(t)),\ -\infty< t\le 0$, be a Ricci flow on a complete,
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.11" label="asympGSS" -->
**Theorem.** Let $(M,g(t)),\ -\infty<t\le 0$,
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="9.12" -->
**Remark.** We are not claiming that the gradient shrinking soliton is a
...
establish below (see \entryref{da767c71996b} and
\entryref{351e4ac14e4e}) that in the case $n=2,3$, the gradient
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.13" label="scaleinv2" -->
**Claim.** For each $k\ge 1$ denote by $x_k\in M_k$ the point $(p,0)\in
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.14" label="redvolconst" -->
**Corollary.** There is a non-negative constant $V_\infty<(4\pi)^{n/2}$ such that
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.15" label="tausqtau" -->
**Claim.** For any $\tau>0$ we have
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.16" label="lxkest" -->
**Corollary.** There is a positive continuous function $C_1(\tau)$ defined for
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.17" -->
**Corollary.** After passing to a subsequence of the $\tau_k$ there is a smooth
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.18" label="linfest" -->
**Corollary.** For any $\tau>0$ and any $q$ we have
...
\entryref{611a73900deb}.
<!-- astrolabe:end -->

**Proof.** This is immediate from \entryref{611a73900deb} and Fatou's lemma.

<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="9.19" -->
**Remark.** **N.B.** We are not claiming that $l_\infty$ is the reduced length
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.20" label="weakeqn" -->
**Proposition.** The function $l_\infty$ is a smooth function
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.21" label="nablaconv" -->
**Lemma.** For any $t\in (-\infty,0)$ we have

$$
\mathit{lim}_{k\rightarrow\infty}|\nabla^{h_k} l_k|_{h_k}^2d\mathit{vol}(h_k)
=|\nabla l_\infty|_{g_\infty}^2 d\mathit{vol}(g_\infty)
$$
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.22" -->
**Claim.**
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.23" -->
**Lemma.** Consider the distribution
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.24" label="etimesdis" -->
**Corollary.** The functional
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.25" label="lowerbdd" -->
**Lemma.** There is a constant $c_1>0$ depending only on the dimension $n$ such
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.26" -->
**Corollary.** For any $q'\in M$ and any $0<\tau_0\le\tau'$ we have

$$
l_{x_k}(q',\tau') \ge -\frac{n}{2(\tau')^2}-\frac{\tau'}{2}-1+c_1\frac{d_{g^2_k(-\tau_0)}(q_k,q')}{\tau'},
$$

where $c_1$ is the constant from \entryref{a6ee3b2ab615}.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.27" label="absconv1" -->
**Claim.** Fix a compact interval $[-\tau,-\tau_0]\subset
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.28" label="absconv" -->
**Corollary.** The distributions $|\nabla l_\infty|^2e^{-l_\infty}$,
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.29" label="absconv2" -->
**Claim.** Suppose that $\varphi$ and $\psi_k$ are as in \entryref{1766f37a13cf},
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.30" label="weakneg" -->
**Corollary.** Fix $0<\tau_0<\tau_1<\infty$. Let $f$ be a non-negative, smooth
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.31" -->
**Claim.**
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.32" label="gradshrink" -->
**Proposition.** The following equation holds on $M_\infty\times (-\infty,0)$:
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.33" label="9.1" -->
**Lemma.** Let $(M,g(t)),\ 0\le t\le T$, be an $n$-dimensional Ricci flow, and
...
$$
 ...
 satisfies the conjugate heat
equation

$$
-\frac{\partial u}{\partial t}-\triangle u+Ru=0,
$$
...
\bigl|\mathit{Ric}_g+\mathit{Hess}^g(f)-\frac{1}{2\tau}g\bigr|^2u.
$$
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.34" label="11.20" -->
**Claim.**
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.35" -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.36" -->
**Claim.** If, for some $t\in (-\infty,0)$, the Riemannian manifold
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.37" label="4times" -->
**Lemma.** Let $(M,g)$ be a Riemannian manifold and let $p\in M$ and $r>0$ be
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.38" label="pp" -->
**Corollary.** Let $(M,g)$ be a Riemannian manifold and let $p\in M$ and $r>0$ be given.
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.39" label="prodatinf" -->
**Proposition.** Suppose that $(M,g(t)),\ -\infty <t< 0$, is a $\kappa$-non-collapsed
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.40" label="compact2D" -->
**Corollary.** There is no two-dimensional flow satisfying the hypotheses of
\entryref{703d5ca9da05}.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.41" -->
**Definition.** Let $(M,g)$ be an $n$-dimensional complete Riemannian manifold and
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.42" label="GSSclass" -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.43" -->
**Claim.** Suppose that $(M,g)$ and $f\colon M\to \Ar$ satisfies the hypotheses of
\entryref{2d68880771ff} and that $M$ is compact and of positive curvature. Then
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.44" label="compactcase" -->
**Corollary.** Suppose that $(M,g(t))$ is a $\kappa$-solution of dimension $3$ with a compact
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.45" label="flatssplit" -->
**Claim.** Suppose that $(M,g)$ and $f\colon M\to \Ar$ are as in the statement
of \entryref{2d68880771ff} and that $(M,g)$ does not have strictly
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.46" label="noncompsol" -->
**Proposition.** There is no two- or three-dimensional Ricci flow satisfying the hypotheses of
\entryref{2d68880771ff} with $(M,g)$ non-compact and of positive curvature.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.47" -->
**Claim.** There is a constant $C$ independent of the choice of
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.48" -->
**Claim.** $|\mathit{Ric}(X,\cdot)|^2\le R \cdot \mathit{Ric}(X,X)$.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.49" label="compact2Dsol" -->
**Corollary.** There is no non-compact, two-dimensional Riemannian manifold $(M,g)$
satisfying the hypotheses of \entryref{2d68880771ff}. For any
non-compact three-manifold $(M,g)$ of positive curvature satisfying
the hypotheses of \entryref{2d68880771ff}, there is a sequence of
points $q_i\in M$ tending to infinity such that $\mathit{lim}_{i\rightarrow \infty}R_g(q_i)=\mathit{sup}_{p\in M}$ such that the
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.50" label="2DGSS" -->
**Corollary.** - **(1)** Let $(M,g(t))$ be a two-dimensional Ricci flow satisfying all
the hypotheses of \entryref{da767c71996b} except possible the
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.51" -->
**Claim.** The scalar curvature of $(S^2,h(-1))$ is equal to $1$.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.52" label="3Dinfty" -->
**Corollary.** Let $(M,g(t))$ be a three-dimensional Ricci flow satisfying the hypotheses of
\entryref{703d5ca9da05}. Then the limit constructed in that proposition
...
\entryref{703d5ca9da05} is the product of a shrinking family of round
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.53" label="3DGSSkappa" -->
**Corollary.** Let $(M,g(t)),\ -\infty<t<0$, be an asymptotic gradient shrinking soliton for a
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.54" -->
**Corollary.** Let $(M,g(t)),\ -\infty<t\le 0$, be a $\kappa$-solution of dimension three.
Then any asymptotic gradient shrinking soliton $(M_\infty,g_\infty(t))$ for
this $\kappa$-solution, as constructed in \entryref{671402eb454b}, is of one of
the three types listed in \entryref{2d68880771ff}.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.55" -->
**Definition.** Let $(M,g)$ be a complete, connected, non-compact Riemannian manifold of
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.56" label="asympscal" -->
**Proposition.** Suppose that $(M,g(t)),\ -\infty<t<0$, is a connected, non-compact
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.57" -->
**Claim.** $S_\infty(M,p)$ is isometric to a round $2$-sphere.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.58" label="kappa0" -->
**Proposition.** There is a $\kappa_0>0$ such that any non-round $3$-dimensional
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.59" label="asympvol" -->
**Theorem.** For (This theorem and all the other results of this section are valid
in all dimensions. Our proofs use \entryref{5d9f1b75170d} and
\entryref{703d5ca9da05} which are also valid in all dimensions but which we
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.60" label="volcomp" -->
**Proposition.** Fix the dimension $n$.
...
$r_k^2Q_k\rightarrow\infty$ as $k\rightarrow\infty$. Then $\mathit{Vol} B(p_k,0,A/\sqrt{Q_k})< \nu(A/\sqrt{Q_k})^n$ for all $k$
sufficiently large.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.61" -->
**Claim.** Suppose that $(M,g(t))$ is an ancient Ricci flow such that for each
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.62" label="bdvolbdcurv" -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.63" label="global" -->
**Corollary.** Fix the dimension $n$. Given $\nu>0$, there is a function
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.64" label="compactkappa" -->
**Theorem.** Let $(M_k,g_k(t),(p_k,0))$ be a sequence of based $3$-dimensional
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.65" label="proposition" -->
**Lemma.** For each $r<\infty$ there is a constant $C(r)<\infty$, such that the
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.66" label="2Rbound" -->
**Claim.** There is a universal (i.e., independent of the $3$-dimensional
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.67" -->
**Claim.** Given any constant $c>0$ there is a constant $\widetilde
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.68" label="zkbound" -->
**Claim.** There is a universal (i.e., independent of the $3$-dimensional
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.69" label="bdnearxk" -->
**Claim.** There are universal constants $\delta>0$ and $C_1<\infty$
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.70" label="rho" -->
**Corollary.** Fix $\delta>0$ the universal constant of the last
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.71" label="derivcor" -->
**Corollary.** Given $\kappa>0$, there is $C<\infty$ such that for any
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.72" label="epscap" -->
**Definition.** Fix constants $0<\epsilon<1/2$ and $C<\infty$. Let $(M,g)$ be a
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="9.73" -->
**Remark.** If the ball $B(y,r_y)$ meets the complement of the core of
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.74" label="partialtR" -->
**Claim.** Suppose that $(M,g(t))$ is a Ricci flow and that $\left({\mathcal
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.75" label="Ccomponent" -->
**Definition.** Fix a positive constant $C$. A compact connected Riemannian manifold
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.76" label="defnepsround" -->
**Definition.** Fix $\epsilon>0$. Let $(M,g)$ be a compact, connected $3$-manifold.
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.77" -->
**Definition.** Fix $C<\infty$ and $\epsilon>0$. For any Riemannian manifold
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.78" label="defncanonnbhd" -->
**Definition.** Fix constants $C<\infty$ and $\epsilon>0$. Let $({\mathcal M},G)$ be
...
interval (see \entryref{755d47f17b43} for the notion of two
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.79" label="canonvary" -->
**Proposition.** The following holds for any $\epsilon<1/4$ and any $C<\infty$. Let
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.80" label="strepsopen" -->
**Corollary.** In an ancient solution $(M,g(t))$ the set of points that are centers
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.81" label="epstube" -->
**Definition.** *An $\epsilon$-tube ${\mathcal T}$* in
...
<!-- astrolabe:begin kind="definition" src="morgan-tian" mtref="9.82" -->
**Definition.** A *strong $\epsilon$-tube* in a
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.83" label="infprod2" -->
**Proposition.** Let $(M,g(t))$ be a $3$-dimensional $\kappa$-solution. Then one of
the following hold:
...
<!-- astrolabe:begin kind="lemma" src="morgan-tian" mtref="9.84" -->
**Lemma.** Let $(M,g(t))$ be a non-compact $3$-dimensional $\kappa$-solution of
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.85" label="uniformD" -->
**Proposition.** For any $0<\epsilon$ sufficiently small there are constants
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="9.86" -->
**Remark.** In Part 1 of this theorem one can replace $p$ by any point $p'\in
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.87" -->
**Claim.** $d_0^2(p_k,q_k)Q_k\rightarrow \infty$ as $k\rightarrow \infty$.
<!-- astrolabe:end -->
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.88" label="noncompkappa" -->
**Corollary.** There is $\bar\epsilon_2>0$ such that for any $0<\epsilon\le \bar
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.89" label="thmep3" -->
**Theorem.** There is $\bar \epsilon_3>0$ such that for every $0<\epsilon\le \bar
...
<!-- astrolabe:begin kind="claim" src="morgan-tian" mtref="9.90" -->
**Claim.** Assuming that $(M,g(0))$ is compact but not of constant positive
...
<!-- astrolabe:begin kind="proposition" src="morgan-tian" mtref="9.91" -->
**Proposition.** Let $\bar\epsilon_2$ and $\bar \epsilon_3$ be as in
\entryref{274cda9be677} and \entryref{a4ea411d0765}, respectively.
For each $0<\epsilon\le \mathit{min}(\bar \epsilon_2,\bar\epsilon_3)$
let $C_1=C_1(\epsilon)$ be as in \entryref{a4ea411d0765}. There is
...
<!-- astrolabe:begin kind="remark" src="morgan-tian" mtref="9.92" -->
**Remark.** For a round $\kappa$-solution $(M,g(t))$ we have $R(x,0)=R(y,0)$ for
...
<!-- astrolabe:begin kind="theorem" src="morgan-tian" mtref="9.93" label="kappasummary" -->
**Theorem.** There is $\bar \epsilon>0$ such that the following is true for any
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.94" label="kappacannbhd" -->
**Corollary.** For every $0<\epsilon\le\bar\epsilon'$ there is
...
<!-- astrolabe:begin kind="corollary" src="morgan-tian" mtref="9.95" label="limitcannbhd" -->
**Corollary.** Fix $0<\epsilon\le \bar\epsilon'$, and let $C(\epsilon)$ be as in
