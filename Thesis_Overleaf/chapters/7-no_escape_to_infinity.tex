...
\begin{proposition}\label{prop:non-escape}
    ...
    \begin{equation*}
        \haus^n(\Gamma_{t'}\cap M) \geq W_g(U),
    \end{equation*}
    and such that $\haus^n(\Gamma_{t'}\cap cl(U)) \geq \eps(U)$.
\end{proposition}
...
\begin{lemma}\label{lem:nested-sweepout-small-intersection}
    ...
    \begin{enumerate}
        \item $\max\br{\eps, \eps_1} < \haus^n(\partial_{rel}U)/10$;
        \item If $\eps_0 < \haus^{n + 1}(\Omega'\cap U) < \haus^{n + 1}(U) - \eps_0$, then $\haus^n(\partial_{rel}\Omega'\cap U) > 2\eps$;
        \item 
        \begin{enumerate}
            \item[(A)] If $\haus^{n + 1}(\Omega'\cap U) < 2\eps_0$, then there exists a family of open sets $\br{\Xi_t}$ with 
            \begin{equation*}
                \begin{split}
                    &\Xi_0 = \Omega';\\
                    &\Xi_t\backslash N_{\eps_1}(U) = \Omega'\backslash N_{\eps_1}(U);\\
                    &\Xi_1\cap U = \varnothing\\
                    &\haus^n(\partial_{rel}\Xi_t) < \haus^n(\partial_{rel}\Omega') + \haus^n(\partial_{rel}U) + \eps_1.
                \end{split}
            \end{equation*}
            \item[(B)] If $\haus^{n + 1}(\Omega'\cap U) > \haus^{n + 1}(U) - 2\eps_0$, then there exists a family of open sets $\br{\Xi_t}$ with
            \begin{equation*}
                \begin{split}
                    &\Xi_0 = \Omega';\\
                    &\Xi_t\backslash N_{\eps_1}(U) = \Omega'\backslash N_{\eps_1}(U);\\
    ...
    \end{enumerate}
    \begin{proof}
        Pick some $\eps_1 \in (0, \haus^{n}(\partial_{rel}U)/10)$. 
        ...
        Let $r_0 > 0$ be sufficiently small, so that every ball $B$ of radius $r \in (0, r_0]$ centered at a point in $cl(U)$ is $2$-biLipschitz diffeomorphic to a ball of the same radius in th Euclidean space.
        ...
        \end{equation}
        where $C(n)$ is the constant from Lemma~\ref{lem:morse-separate}. Using the relative coarea formula (Theorem~\ref{thm:coarea-formula}), we may choose a covering $\br{B_i'}$ of $U$ by $N$ balls of radius $r_i \in (r_0/2, r_0)$, so that         \begin{equation}\label{eq:area-of-Bi}
            \haus^n((\partial B_i')\cap(\Omega'\cap U)) \leq \frac{4\eps_0}{r_0} \leq \frac{\eps_1}{5N}.
        \end{equation}
        ...
        \begin{equation*}
            \begin{split}
                \haus^n(\partial_{rel}\Xi_t^1) \leq& \haus^n(\partial_{rel}\Omega') + \haus^n(\partial_{rel}(B_1'\cap U\cap \Omega'))\\
                &+2^nC(n)\haus^{n + 1}(B_1'\cap U\cap \Omega') + \eps\\
                \leq& \haus^n(\partial_{rel}\Omega') + \haus^n(B_1'\cap \partial_{rel} U) + \haus^n((\partial B_1')\cap (\Omega'\cap U))\\
                &+2^nC(n)\eps_0^{\frac{n}{n + 1}} + \eps \quad\text{By \ref{eq:value-of-eps0}}\\
                \leq& \haus^n(\partial_{rel}\Omega') + \haus^n(B_1'\cap \partial_{rel} U) + \frac{\eps_1}{5N} + \frac{\eps_1}{4N} + \eps\quad\text{by~\ref{eq:area-of-Bi}}\\
                \leq& \haus^n(\partial_{rel}\Omega') + \haus^n(B_1'\cap \partial_{rel} U) + \frac{\eps_1}{2N}
            \end{split}
        \end{equation*}
        We can iterate this procedure for each ball $B_i'$. During the $i$-th step, $1 \leq i \leq N$, we have that 
        \begin{equation*}
            \haus^n(\partial_{rel}\Xi_t^i) \leq \haus^n(\partial_{rel}\Omega') + \haus^n( \partial_{rel} U) + \frac{i\eps_1}{2N}
        \end{equation*}
        That means we can conclude 3(A) by after gluing these together via Proposition~\ref{prop:gluing-two-nested}.
    \end{proof}
\end{lemma}
...
\begin{equation*}
    \haus^n(\Gamma_t\cap M) \geq W_g(U)
\end{equation*}
we have $\haus^n(\Gamma_t\cap U) < \eps(U)$. Our goal is to construct a good sweepout entirely
...
Let $f(t) = \haus^n(\Gamma_t\cap U)$. Note that $f(t)$ may not be continuous. However, it is easy
...
\begin{lemma}[$\delta$-continuous perturbation]\label{lem:delta-cts-perturbation}
    ...
    \begin{itemize}
        \item $f(t) = \haus^n(\Gamma_t'\cap U)$ is $\delta$-continuous;
        \item $\sup_{t}\haus^n(\Gamma_t'\cap M) \leq \sup_{t}\haus^n(\Gamma_t\cap M) + \delta$;
        \item $\sup_{t}\haus^n(\Gamma_t'\cap U) \leq \sup_{t}\haus^n(\Gamma_t\cap U) + \delta$.
    \end{itemize}
    \begin{proof}
        ...
        \begin{equation*}
        \begin{split}
        \sup_{t}\haus^n(\widetilde{\Gamma}_t\cap M)
        &\le \sup_{t}\haus^n(\Gamma_t\cap M)+\varepsilon,\\
        \sup_{t}\haus^n(\widetilde{\Gamma}_t\cap U)
        &\le \sup_{t}\haus^n(\Gamma_t\cap U)+\varepsilon.
        \end{split}
        \end{equation*}
        Indeed, the preliminary modification acts only inside finitely many thin annuli and endpoint collars; by (iii)–(iv) of Lemma~\ref{lem:preliminary-modification} the $M$–area increase is $\le\varepsilon$, and restricting to $U$ with the relative coarea formula~\ref{thm:coarea-formula} yields the same $\varepsilon$–bound for the $U$–area.
        ...
        \end{equation*}
        Shrinking $\eta>0$ if necessary and using the relative coarea formula (Theorem~\ref{thm:coarea-formula}) and the small-volume choice from Lemma~\ref{lem:preliminary-modification}, we may assume
        \begin{equation*}
          \haus^n(\partial D_s\cap U)+
          (\haus^{n+1}(D_s))^{\frac{n}{n+1}}
          <\varepsilon_s,
        \end{equation*}
        ...
        \begin{equation*}
            \begin{split}
                \haus^n(\Gamma_t'\cap M)
                \le& \haus^n(\partial\Omega^-\cap M)
                   + \haus^n(\partial D_s\cap M)\\
                   &+ C(n)(1+L_{\mathrm{ball}})^n\big(\haus^{n+1}(D_s))^{\frac{n}{n+1}}
                   + \varepsilon_s,\\
                \haus^n(\Gamma_t'\cap U)
                \le& \haus^n(\partial\Omega^-\cap U)
                   + \haus^n(\partial D_s\cap U)\\
                   &+ C(n)(1+L_{\mathrm{ball}})^n\big(\haus^{n+1}(D_s))^{\frac{n}{n+1}}
                   + \varepsilon_s,
            \end{split}
        ...
        \begin{equation*}
            \begin{split}
                \sup_t \haus^n(\Gamma_t'\cap M)
                &\le \sup_t \haus^n(\Gamma_t\cap M) + \varepsilon + \sum_{s\in\mathcal S}\varepsilon_s \le \sup_t \haus^n(\Gamma_t\cap M)+2\varepsilon,\\
                \sup_t \haus^n(\Gamma_t'\cap U)
                &\le \sup_t \haus^n(\Gamma_t\cap U)+\varepsilon+\sum_{s\in\mathcal{S}}\varepsilon_s \le \sup_t \haus^n(\Gamma_t\cap U)+2\varepsilon.
            \end{split}
        \end{equation*}
...
Let $g:[0,1]\to[0,\haus^{n+1}(U)]$ be defined by
\begin{equation*}
  g(t):=\haus^{n+1}(U\cap\Omega_t),
\end{equation*}
...
$g^{-1}([\eps_0,\ \haus^{n+1}(U)-\eps_0])$, then for every $t\in I'$ we have
\begin{equation*}
  f(t):=\haus^{n}(\Gamma_t\cap U) \ge 2\eps.
\end{equation*}

Applying Lemma~\ref{lem:delta-cts-perturbation} with $\delta<\eps/10$ we obtain a good sweepout
$\br{\Gamma_t'}$ such that $f'(t):=\haus^{n}(\Gamma_t'\cap U)$ is $\delta$-continuous. 
...
\begin{equation}\label{eq:end-of-gt-i}
  g(t_0)\le \varepsilon_0,\qquad g(t_1)\ge \haus^{n+1}(U)-\varepsilon_0,
\end{equation}
...
\begin{equation*}
    g(t_i)\in\bigl(\varepsilon_0,\ \haus^{n+1}(U)-\varepsilon_0),
\end{equation*}
which contradicts our choice of the endpoints (see \ref{eq:end-of-gt-i} the bounds for $g(t_i)$).
...
$g(t_0)\le\varepsilon_0$ and $g(t_1)\ge \haus^{n+1}(U)-\varepsilon_0$ is essential:
...
(iii) on the compact interval $I$ we obtain a strict gap $\sup_{t\in I}\haus^n(\Gamma_t\cap M)<W_g(U)$, 
...
\begin{equation*}
    \begin{split}
        A&:=\br{t\in[0,1]:\ \haus^n(\Gamma_t\cap M)\ge W_g(U)},\\
        B&:=\br{t\in[0,1]:\ g(t)\in(\varepsilon_0,\ \haus^{n+1}(U)-\varepsilon_0)}.
    \end{split}
\end{equation*}
...
\begin{equation*}
\haus^n(\Gamma_t\cap M)\ <\ W_g(U)\qquad\text{for all }t\in I.
\end{equation*}
By piecewise continuity of $t\mapsto \haus^n(\Gamma_t\cap M)$ on the compact interval $I$, there exists
\begin{equation*}
m:=\sup_{t\in I}\haus^n(\Gamma_t\cap M) < W_g(U),\qquad
\delta_1:=W_g(U)-m > 0.
\end{equation*}
...
\begin{equation*}
  \sup_{t\in[0,1]}\haus^n(\overline{\Gamma}_t\cap M)\ \le\ m-\tfrac{\delta_1}{2}\ <\ W_g(U)-\tfrac{\delta_1}{2},
\end{equation*}
and
\begin{equation*}
...
\begin{figure}[htbp]
  ...
  \label{fig:PUbar}
\end{figure}
By the endpoint volume bounds $g(t_0)\le \varepsilon_0$ and $g(t_1)\ge \haus^{n+1}(U)-\varepsilon_0$, both
$\Omega_{t_0}\cap U$ and $U\setminus \operatorname{cl}(\Omega_{t_1})$ have measure $\le \varepsilon_0$, hence
$\haus^{n+1}(P)\le 2\varepsilon_0$. Remove $P$ from $U$ and smooth inward inside a fixed collar of $\partial U$
...
\begin{enumerate}
  ...
  \begin{equation*}
    \haus^n(\partial_{\mathrm{rel}}\overline U)
    \ \le\ \haus^n(\partial_{\mathrm{rel}}U)\ +\ C\,\varepsilon_0^{\frac{n}{n+1}}
    \ \le\ 2\,\haus^n(\partial_{\mathrm{rel}}U)
  \end{equation*}
  ...
  inequalities applied to $\haus^{n+1}(P)\le 2\varepsilon_0$.
  ...
  that pushes $\partial_{\mathrm{rel}}\overline U$ outside $U$ through slices of area at most $3\haus^n(\partial_{rel}U)$, after absorbing the $O(\varepsilon_0^{\frac{n}{n+1}})$ error into the constant (again by choosing
...
\begin{equation*}
  \haus^n((\overline{\Gamma}_{t_0}\cap M)\setminus \overline U)\leq2\haus^n(\partial_{rel} U).
\end{equation*}
\end{lemma}
\begin{proof}
    Let $L:=\sup_{t\in[0,1]}\haus^n\bigl(\overline{\Gamma}_t\cap \overline U)$. By the Morse–foliation construction on $\overline U$ and the relative boundary control in (ii), we can sweep out $\overline U$
    by slices of area at most
\begin{equation*}
  L+\haus^n(\partial_{\mathrm{rel}}\overline U)+\delta \le L+2\,\haus^n(\partial_{\mathrm{rel}}U)+\delta.
\end{equation*}
Using (iii), we extend this to a good sweepout of $U$ (the homotopy is supported in a fixed collar of $\partial U$ and generated by vector fields tangent to $\partial M$) whose maximal slice area is at most $L+2\,\haus^n(\partial_{\mathrm{rel}}U)+\delta$. Hence, by the definition of $W_g(U)$,
\begin{equation*}
  W_g(U)\le L+2\haus^n(\partial_{rel}U)+\delta.
\end{equation*}
If, for every $t\in[0,1]$, we had $\haus^n((\overline{\Gamma}_t\cap M)\setminus \overline U)\ >\ 2\,\haus^n(\partial_{\mathrm{rel}}U),$
then
\begin{equation*}
    \begin{split}
        \haus^n(\overline{\Gamma}_t\cap M) &= \haus^n(\overline{\Gamma}_t\cap \overline U) + \haus^n( (\overline{\Gamma}_t\cap M)\setminus \overline U)\\
        &> L + 2\haus^n(\partial_{\mathrm{rel}}U)\\
        &\geq W_g(U)-\delta
    \end{split}
\end{equation*}
contradicting $\sup_t\haus^n(\overline{\Gamma}_t\cap M)\le W_g(U)-\delta_1/2$ for $\delta>0$ chosen smaller than $\delta_1/2$.
...
and define
\begin{equation*}
  A_i:=\inf\br{\haus^n(\partial_{rel}\Omega) : \Omega\in\mathcal{U}_i},\qquad i=0,1.
\end{equation*}
By Lemma~\ref{lem:barU-slice-outside} and property (ii) for $\overline U$, we have 
\begin{equation*}
  A_i\ \le\ 3\,\haus^n(\partial_{\mathrm{rel}}U).
\end{equation*}
Choose $\Sigma_i=\partial\Xi_i$ with $\Xi_i\in\mathcal U_i$ such that 
\begin{equation*}
  \haus^n(\Sigma_i\cap M)\ \le\ A_i+\delta/4.
\end{equation*}
...
\begin{equation*}
  \sup_{t}\ \haus^n(\Gamma^{\overline U}_t\cap M)\ \le\ W_g(U)-\delta/4.
\end{equation*}
...
\begin{equation*}
  \sup_{t}\ \haus^n(\Gamma^{U}_t\cap M)\ \le\ W_g(U)-\delta/4,
\end{equation*}
