...
theorem DifferentialGeometry.Integral.Measure.chartLocal_weighted_finset_sum_eq_riemannianMeasure_integral
    ...
    ∑ α ∈ chartAtlasPOUFinset (I := I) (M := M),
      ...
      = ∫ x, h x ∂(riemannianMeasureFamily (I := I) (M := M) g_fam t) := by sorry
