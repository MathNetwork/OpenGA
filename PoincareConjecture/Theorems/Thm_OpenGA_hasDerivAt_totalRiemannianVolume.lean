...
theorem OpenGA.hasDerivAt_totalRiemannianVolume [T2Space M] [CompactSpace M]
    ...
    HasDerivAt (fun s => totalRiemannianVolume (g s))
      (∫ x, (1 / 2 : ℝ) * traceTimeDerivMetric I g t x ∂(riemannianVolumeMeasure (I := I) (M := M) (g t))) t := by sorry
