...
import Solutions.Sol_OpenGA_nonempty_measuredSurgeryComparisonData_of_areaEvolution
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.nonempty_measuredSurgeryComparisonData_of_areaEvolution
