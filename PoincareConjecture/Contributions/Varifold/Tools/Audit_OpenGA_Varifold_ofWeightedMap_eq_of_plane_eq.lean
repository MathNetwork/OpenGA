import Solutions.Sol_OpenGA_Varifold_ofWeightedMap_eq_of_plane_eq
import Theorems.Thm_OpenGA_Varifold_ofWeightedMap_eq_of_plane_eq

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.Varifold.ofWeightedMap_eq_of_plane_eq
