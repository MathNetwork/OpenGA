import Solutions.Sol_OpenGA_Varifold_tendsto_weightMeasure_integral
import Theorems.Thm_OpenGA_Varifold_tendsto_weightMeasure_integral

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.Varifold.tendsto_weightMeasure_integral
  ...
  let accepted : Array Name := #[`OpenGA.Varifold.testIntegral_ofWeightedMap,`OpenGA.Varifold.ofWeightedMap_eq_of_plane_eq,`OpenGA.Varifold.testIntegral_ofParametrization,`OpenGA.Varifold.ofParametrization_independent_of_lift,`OpenGA.Varifold.mass_ofParametrization_le_energy,`OpenGA.areaDensity_eq_normDet,`OpenGA.integral_areaDensity_le_energyDensity]
