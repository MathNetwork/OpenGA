import Solutions.Sol_OpenGA_Varifold_testIntegral_ofWeightedMap
import Theorems.Thm_OpenGA_Varifold_testIntegral_ofWeightedMap

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.Varifold.testIntegral_ofWeightedMap
