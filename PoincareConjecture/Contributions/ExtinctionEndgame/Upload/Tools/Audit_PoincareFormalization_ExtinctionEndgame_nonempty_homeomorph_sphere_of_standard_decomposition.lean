import Solutions.Sol_PoincareFormalization_ExtinctionEndgame_nonempty_homeomorph_sphere_of_standard_decomposition
import Theorems.Thm_PoincareFormalization_ExtinctionEndgame_nonempty_homeomorph_sphere_of_standard_decomposition

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `PoincareFormalization.ExtinctionEndgame.nonempty_homeomorph_sphere_of_standard_decomposition
  ...
  let accepted : Array Name := #[`PoincareFormalization.ExtinctionEndgame.simply_connected_factors_of_connected_sum,`PoincareFormalization.ExtinctionEndgame.not_simply_connected_sphere_handle,`PoincareFormalization.ExtinctionEndgame.nonempty_homeomorph_sphere_of_connected_sum_spheres,`PoincareFormalization.covering_is_homeomorph]
