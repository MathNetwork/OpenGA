import Solutions.Sol_OpenGA_SurgeryTopologyEvolution_topology_from_extinction
import Theorems.Thm_OpenGA_SurgeryTopologyEvolution_topology_from_extinction

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.SurgeryTopologyEvolution.topology_from_extinction
