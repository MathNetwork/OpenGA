import Solutions.Sol_OpenGA_WidthComparisonTrace_le_extinctionTime
import Theorems.Thm_OpenGA_WidthComparisonTrace_le_extinctionTime

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.WidthComparisonTrace.le_extinctionTime
  ...
  let accepted : Array Name := #[`OpenGA.scalar_lower_bound_across_upward_jumps,`OpenGA.eventually_width_slope_lt_of_comparison,`OpenGA.le_width_deadline_across_downward_jumps]
