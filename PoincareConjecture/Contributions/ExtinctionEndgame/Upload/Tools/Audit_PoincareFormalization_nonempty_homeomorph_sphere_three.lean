import Solutions.Sol_ExtinctionEndgameRoot
import Theorems.Thm_PoincareFormalization_nonempty_homeomorph_sphere_three

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `PoincareFormalization.nonempty_homeomorph_sphere_three
  ...
  let accepted : Array Name := #[`PoincareFormalization.ExtinctionEndgame.exists_width_controlled_surgery_topology,`OpenGA.SurgeryTopologyEvolution.finiteExtinction_of_width_control,`OpenGA.SurgeryTopologyEvolution.topology_from_extinction,`PoincareFormalization.ExtinctionEndgame.nonempty_homeomorph_sphere_of_standard_decomposition]
