import Solutions.Sol_OpenGA_SurgeryTopologyEvolution_finiteExtinction_of_width_control
import Theorems.Thm_OpenGA_SurgeryTopologyEvolution_finiteExtinction_of_width_control

import Lean.Util.CollectAxioms
open Lean in
run_meta do
  let target ← getConstInfo `OpenGA.SurgeryTopologyEvolution.finiteExtinction_of_width_control
  ...
  let accepted : Array Name := #[`OpenGA.WidthComparisonTrace.le_extinctionTime]
