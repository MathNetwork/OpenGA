import Theorems.Thm_DifferentialGeometry_Integral_Measure_chartLocal_weighted_finset_sum_eq_riemannianMeasure_integral
import Solutions.Sol_DifferentialGeometry_Integral_Measure_chartLocal_weighted_finset_sum_eq_riemannianMeasure_integral
import Lean
open Lean in
run_meta do
  let env ← getEnv
  let some target := env.find? `DifferentialGeometry.Integral.Measure.chartLocal_weighted_finset_sum_eq_riemannianMeasure_integral | throwError "Missing target"
