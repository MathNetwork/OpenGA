...
theorem DifferentialGeometry.Integral.Measure.hasDerivAt_chartDensityFamily_eq_half_trace_inv_mul
    ...
    HasDerivAt
      ...
      ((1 / 2) *
        ...
        Real.sqrt (chartGramMatrixFamily (I := I) g_fam x₀ x t).det) t := by sorry
