...
import Solutions.Sol_DifferentialGeometry_Geometry_Riemannian_VolumeComparison_lintegral_Iic_cross
open Lean in
run_meta do
  let target ← Lean.getConstInfo `DifferentialGeometry.Geometry.Riemannian.VolumeComparison.lintegral_Iic_cross
