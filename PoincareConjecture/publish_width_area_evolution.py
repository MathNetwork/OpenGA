#!/usr/bin/env python3
"""Resume the validated uniform-area-evolution reduction and verify root reachability."""
...
D=ROOT/'Contributions/WidthAreaEvolution'
def main():
 ...
 required.update({k:r['external_ids'][k] for k in r['external_ids']})
